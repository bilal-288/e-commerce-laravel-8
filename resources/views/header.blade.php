    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                @if(Session()->has('user'))
                <li class=""><a href="{{route('all_orders')}}">Orders</a></li>

                @else
                <li class=""><a href="/index">Orders</a></li>
                @endif
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="{{route('cart.list')}}">Cart({{$total_items}})</a></li>
                ...
                <li><a href="{{route('user_register_view')}}">Register</a></li>
                @endif
